...
import model.WeatherConditionsFactory;
...
public class OpenWeatherClient {
    ...
    public WeatherConditions currentWeatherAtCity(String cityName, String countryCode) throws Exception {
        String jsonResponse = client.target(baseUrl)
                ...
                .get(String.class);
        return WeatherConditionsFactory.create(jsonResponse);
    }
