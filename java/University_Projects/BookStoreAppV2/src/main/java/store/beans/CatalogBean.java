...
public class CatalogBean implements Serializable {
    ...
    public String getKidsBooks() {
        ...
        items = catalog_.findByCategory(em,CatalogItem.KIDS);
        return "catalogPage";
    }
    /**
    ...
    public String getTechBooks() {
        ...
        items = catalog_.findByCategory(em,CatalogItem.TECH);
        return "catalogPage";
    }
    
    public void orderItem() {
        CatalogItem item = catalog_.findItem(em,orderItemId);
        if (item != null) {
    ...
    public void addBook() {
        FacesContext context = FacesContext.getCurrentInstance();
        ResourceBundle bundle = context.getApplication().getResourceBundle(context, "msg");
        if (catalog_.addItem(em, utx, id, shortDescription,longDescription,cost, category)) {
