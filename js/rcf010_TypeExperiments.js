...
for (x of ["One","Two",10,5.1,true,false,undefined,null,"String"])
...
for (x of ["Paris    ","London  ","Shanghai","New York","Toronto ",""])
  console.log(x.toLowerCase()+"\t"+x.toUpperCase()+"\t"+x.charAt(0)+"\t\t"+x.substring(2,5));
