 ...
 * 
 * 
 * THIS IS THE RAW SEARCH ALGORITHM, WITHOUT FULL I/O. Testing version is SearchAlg_InputTesting.
 */


public class SearchAlg_V1 {
	...
	public static void Search(String input, String type, String category, Recipe[] recipes)
	{
		if(!input.isEmpty())
		{
			...
			String[][] inputList = new String[tempInputList.length][2];
